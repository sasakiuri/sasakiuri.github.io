...
梶ヶ谷宜之のホームページです。表示デザインを維持したまま、Next.js App Router と静的エクスポートを使う構成にしています。
...
設計上の判断と変更してはいけない表示仕様は [architecture.md](docs/architecture.md)、兄弟リポジトリからの採用判断は
[tooling-adoption.md](docs/tooling-adoption.md) にまとめています。
